...
namespace LoginAndDataGridApp
{
    public partial class DataGridForm : Form
    {
        ...
        private void LoadCourseData()
        {
            ...
            // Example data
            string[] row1 = { "IT-100", "software Engineering", "85", "A+", "Pass" };
            string[] row2 = { "IT-125", "Object Oriented Programming", "70", "B+", "Pass" };
            string[] row3 = { "IT-136", "Discrete Structure", "75", "A", "Pass" };
